...
export const datasets: Dataset[] = [
  {
    id: "fs-map-layer",
    name: "Fixed Site Map Layer",
    description:
      "Authoritative locations of BioMed fixed donor sites used for the fixed-site footprint and trade-area drill-down.",
    usedIn: "Explore Regions · BioMed Collections (Fixed Sites)",
    ...
    refresh: "Maintained in AGOL — confirm refresh cadence with Troy.",
    status: "maintained",
  },
  {
    id: "redcell-trade-area",
    name: "Red Cell Fixed Sites Trade Area",
    description:
      "Trade-area polygons showing the observed donor reach of each fixed site, built from donor behavior and migration patterns. Red cell only.",
    usedIn: "Explore Regions (Fixed-Site Trade Area)",
    sourceSystem: "Red Cross ArcGIS Online (dashboard)",
    link: `${AGOL}/apps/dashboards/f2e70959109342fca8da1fd33cfc54b2`,
    owner: "BioMed (Troy Rathbun)",
    refresh: "Confirm attribute definitions and refresh cadence with Troy.",
    status: "maintained",
    notes: "Platelet trade areas are a later phase — do not imply platelet behavior from red cell polygons.",
  },
  {
